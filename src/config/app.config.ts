export const APP_CONFIG = {
  ...
  adminUids: ['VYSAvnGuvKW3AbFUNA3iLGEX1XU2'],
  categories: [
    {
      id: 'general',
      name: 'General',
      description: 'Open random chat',
      icon: '💬',
    ...
    },
    {
      id: 'friendship',
      name: 'Friendship',
      description: 'Make anonymous friends',
      icon: '🤝',
    ...
    },
    {
      id: 'romantic',
      name: 'Romantic',
      description: 'Flirty & romantic vibes',
      icon: '💜',
